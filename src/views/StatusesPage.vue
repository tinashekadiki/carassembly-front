        ...
        <div class="card-body">
          <div class="row">
            ...
            <div class="col-md-2 mt-30">
              <button class="btn btn-facebook btn-block" @click="saveStatus()">
                Save Status
              </button>
            </div>
          </div>
...
export default {
  ...
  methods: {
    ...
    saveStatus() {
      ...
      if (this.status.id) {
        http
          .put(`status/edit/${this.status.id}`, this.status)
          .then((res) => {
            console.log(res);
          })
          .catch((err) => {
        ...
        http
          .post("status/create", this.status)
          .then((res) => {
            console.log(res);
          })
          .catch((err) => {
