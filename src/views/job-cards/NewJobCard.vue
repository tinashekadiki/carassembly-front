        ...
        <div class="row">
          <div class="col-sm-6">
            <div class="form-group">
              ...
              <input v-if="!editing" class="form-control" type="date" placeholder="Input date"
...
<!--                       v-model="jobCard.vehicle.attribute.serviceType.serviceTypeName">-->
        ...
        <div v-if="editing" class="card-header"><strong>Advisor</strong> <small>Details</small></div>
        <div v-if="editing" class="card-body">
          <div class="row">
            <div class="col-md-6">
              <div class="form-group">
                <label>Assign Advisor</label>
                <select class="form-control" v-model="jobCard.vehicle.attribute.advisor">
                  <option value="null">Select Advisor</option>
                  <option v-for="advisor in advisorsList" :key="advisor.id" :value="advisor">
        ...
        <div class="order-parts" v-if="editing">
          ...
          <div class="card-body">
            ...
            <table v-if="orderParts.length" class="table table-responsive-sm table-striped table-bordered">
              <thead>
              <tr>
                <th>Part Name</th>
                <th>Price</th>
